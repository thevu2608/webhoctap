(this["webpackJsonpedu-lms"] = this["webpackJsonpedu-lms"] || []).push([[18], {
    2035: function(t, n, e) {
        "use strict";
        e.r(n),
        ...
        var i, a, r = function(t) {
        ...
        }, u = !1, s = !1, c = function(t) {
            u = !t.persisted
        }, d = function(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            s || (addEventListener("pagehide", c),
            ...
            return function() {
                ...
                n.value >= 0 && (i || n.isFinal || "hidden" === document.visibilityState) && (n.delta = n.value - (a || 0),
                (n.delta || n.isFinal || void 0 === a) && (t(n),
                a = n.value))
            }
        }, f = function(t) {
            var n, e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = r("CLS", 0), a = function(t) {
            ...
            return void 0 === i && (i = "hidden" === document.visibilityState ? 0 : 1 / 0,
            d((function(t) {
                var n = t.timeStamp;
                return i = n
            }
            ...
            var n, e = r("FCP"), i = l(), a = o("paint", (function(t) {
                "first-contentful-paint" === t.name && t.startTime < i.timeStamp && (e.value = t.startTime,
                e.isFinal = !0,
                e.entries.push(t),
                n())
            }
            ...
            var n = r("FID")
              , e = l()
              , i = function(t) {
                t.startTime < e.timeStamp && (n.value = t.processingStart - t.startTime,
                n.entries.push(t),
                n.isFinal = !0,
                u())
            }
            ...
            a ? d((function() {
                ...
                i.timeStamp < e.timeStamp && (n.value = t,
                n.isFinal = !0,
                n.entries = [{
            ...
            var n, e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = r("LCP"), a = l(), u = function(t) {
                var e = t.startTime;
                e < a.timeStamp ? (i.value = e,
                i.entries.push(t)) : i.isFinal = !0,
                n()
            }, s = o("largest-contentful-paint", u);
            if (s) {
                n = p(t, i, s, e);
                var c = function() {
                    i.isFinal || (s.takeRecords().map(u),
                    i.isFinal = !0,
                    n())
                };
                g().then(c),
...
//# sourceMappingURL=18.8804091f.chunk.js.map
