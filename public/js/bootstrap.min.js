    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (d) {
                ...
                r = "bottom" == r && h.bottom + c > f.bottom ? "top" : "top" == r && h.top - c < f.top ? "bottom" : "right" == r && h.right + p > f.width ? "left" : "left" == r && h.left - p < f.left ? "right" : r, s.removeClass(u).addClass(r)
            }
